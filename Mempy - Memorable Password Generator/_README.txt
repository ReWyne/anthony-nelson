...
My solution is a simple password generator based on early 2017 hacking methods.
...
brute force attack (treating the password as a completely random string) long
...
I'll say it again: NEVER reuse passwords for more than one thing, unless you're
OK with having everything you were using that password for hacked, losing those
